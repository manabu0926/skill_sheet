...
また、２年半以上、完全在宅での作業をしているため、Slack等のテキストによるコミュニケーションも一定レベルはこなせると自負しております。

対面でのMTG等も抵抗はまったくないので、(むしろ対面で話せるほうがありがたいくらい)出社での打ち合わせも問題有りません。
...
- **担当した開発内容**
    ...
    - 新業務システム技術選定、MVP作成
        ...
        - Next.js、Prisma、AllTypeScriptでの開発における技術選定や実装方針の策定
    ...
    - エンジニア採用に関わる業務
        ...
        - スカウト内容に関する意見提案等
- **意識したこと**
    - テックリードポジションとして活動していたので、いかにチームがストレス少なく、快適な開発体験を得られるか？という点を意識して整備をしてきました。
    - 一方的にこれでお願いしますという形ではなく、これでどうでしょうか？というスタンスでチームメンバーとやり方をすり合わせしながら、確実に良い方向には進む技術選定や方針設定をするよう心がけました。
    - 採用業務等は、ただ見極めるだけでなく、こちらの魅力づけやいかに「栗田」に対して好感を持ってもらえるように話を展開させるか？という点も気にしておりました。
