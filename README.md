...
　　　　　
    - 新業務システム技術選定、MVP作成(All TypeScript)
...
- **担当した開発内容**
    - 求職者、求人企業、運営サイド画面の開発全般
        - 各店舗で抱えているドライバーが、他の人手が足りてない店舗にマッチング＆配車を行うサービス(スマホアプリ、web)
            ...
            - 上記に関わる部分のすべての機能、現在α版のリリースに向けた開発及びテスト実装中
        - Rubyに関しては型定義(Rbs, steep)を導入して、メンテナンス容易性を高める工夫もしています。
        - 基本的に言語は最新のバージョンで開発するように心がけています。
        - 
- **意識したこと**
    - ２度ほど、先方のディレクションミスで大きな仕様変更があり作り直している経緯がある＆ディレクションをするメンバーがロースキルなのもあり、細かく仕様を詰めるといった点や、Figmaの使い方の指導や、クライアントとの確認のすり合わせ方法を教育
    - 一人で開発をしているので、いかに開発生産性を上げるか？ということを意識し、Cursorやv1などのAIエディタツールを活用し、少ない稼働時間で開発のアウトプットを出すことを心がけています。
    - 業界特有の風習に伴う仕様等に柔軟に対応できるよう、細かく仕様を確認して、都度すり合わせを実施するように心がけています。
